...
export default function TodosPanel({
  ...
  return (
    <div className="z-20 flex flex-col bg-[#0a0a0c]/90 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl w-full sm:w-[820px] max-w-[95vw] h-[85vh] sm:h-[520px] p-4 sm:p-6 transition-all -translate-y-2 overflow-y-auto">
      ...
      <div className="bg-[#111115] border border-white/10 rounded-2xl p-4 sm:p-5 mb-6">
              ...
              {todayTodos.length === 0 ? (
                ...
                todayTodos.map((todo: Todo) => {
                  ...
                  return (
                    <div
                      key={todo.id}
                      className="bg-black/40 border border-white/5 rounded-xl p-3 sm:p-4"
                    >
                      <div className="flex flex-wrap justify-between items-center gap-y-2 mb-2">
                        <div className="flex flex-wrap items-center gap-2 min-w-0">
                          ...
                          ></span>
                          <span
                            className={`font-semibold text-sm truncate max-w-[45vw] sm:max-w-none ${done ? "text-white/50 line-through" : "text-white/90"}`}
                          >
                            {todo.name}
                          </span>
                          <span className="text-[9px] uppercase tracking-wider text-white/40 bg-white/5 border border-white/10 rounded px-1.5 py-0.5 sm:ml-2">
                            Today
                          </span>
              ...
              <div className="flex flex-col gap-2">
                {[...pastTodos, ...laterTodos].map((todo: Todo) => {
                  ...
                  return (
                    <div
                      key={todo.id}
                      className="flex flex-wrap justify-between items-center gap-y-1 gap-x-2 bg-black/30 border border-white/5 px-3 py-2 rounded-lg text-xs"
                    >
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        ></span>
                        <span
                          className={`truncate max-w-[40vw] sm:max-w-none ${done ? "text-white/40 line-through" : "text-white/80"}`}
                        >
                          {todo.name}
                        </span>
